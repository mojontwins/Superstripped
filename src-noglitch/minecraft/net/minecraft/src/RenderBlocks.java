...
public class RenderBlocks {
	...
	public boolean renderLog(Block block, int x, int y, int z) {
		...
		int orientation = GameRules.renderAllBlocksStraight ? 0 : (meta & 12);
	...
	public void renderBlockAsItem(Block block, int i2, float f3) {
		Tessellator tessellator = Tessellator.instance;
		boolean z5 = block.blockID == Block.grass.blockID;
		int i6;
		float f7;
		float f8;
		float f9;
		if(this.useInventoryTint) {
			i6 = block.getRenderColor(i2);
			if(z5) {
				i6 = 0xFFFFFF;
			}
		...
		if(i6 != 0 && i6 != 31 && i6 != 16) {
			if(i6 == 1) {
				...
				this.drawCrossedSquares(block, i2, -0.5D, -0.5D, -0.5D);
				tessellator.draw();
			} else if(i6 == 19) {
				tessellator.startDrawingQuads();
				tessellator.setNormal(0.0F, -1.0F, 0.0F);
				block.setBlockBoundsForItemRender();
				this.renderBlockStemSmall(block, i2, block.maxY, -0.5D, -0.5D, -0.5D);
				tessellator.draw();
			} else if(i6 == 23) {
				tessellator.startDrawingQuads();
				tessellator.setNormal(0.0F, -1.0F, 0.0F);
				...
				tessellator.addTranslation(0.0F, 0.0F, f7);
				...
				tessellator.addTranslation(f7, 0.0F, 0.0F);
				...
				ChestItemRenderHelper.instance.remder(block, i2, f3);
				GL11.glEnable(GL12.GL_RESCALE_NORMAL);
			} else if(i6 == 6) {
				tessellator.startDrawingQuads();
				tessellator.setNormal(0.0F, -1.0F, 0.0F);
				this.renderBlockCropsImpl(block, i2, -0.5D, -0.5D, -0.5D);
				tessellator.draw();
			} else if(i6 == 2) {
				tessellator.startDrawingQuads();
				tessellator.setNormal(0.0F, -1.0F, 0.0F);
				...
				for(i14 = 0; i14 < 4; ++i14) {
					f8 = 0.125F;
					if(i14 == 0) {
						block.setBlockBounds(0.5F - f8, 0.0F, 0.0F, 0.5F + f8, 1.0F, f8 * 2.0F);
					}

					if(i14 == 1) {
						block.setBlockBounds(0.5F - f8, 0.0F, 1.0F - f8 * 2.0F, 0.5F + f8, 1.0F, 1.0F);
					}

					f8 = 0.0625F;
					if(i14 == 2) {
						block.setBlockBounds(0.5F - f8, 1.0F - f8 * 3.0F, -f8 * 2.0F, 0.5F + f8, 1.0F - f8, 1.0F + f8 * 2.0F);
					}

					if(i14 == 3) {
						block.setBlockBounds(0.5F - f8, 0.5F - f8 * 3.0F, -f8 * 2.0F, 0.5F + f8, 0.5F - f8, 1.0F + f8 * 2.0F);
					}
				...
				for(i14 = 0; i14 < 3; ++i14) {
					f8 = 0.0625F;
					if(i14 == 0) {
						block.setBlockBounds(0.5F - f8, 0.3F, 0.0F, 0.5F + f8, 1.0F, f8 * 2.0F);
					}

					if(i14 == 1) {
						block.setBlockBounds(0.5F - f8, 0.3F, 1.0F - f8 * 2.0F, 0.5F + f8, 1.0F, 1.0F);
					}

					f8 = 0.0625F;
					if(i14 == 2) {
						block.setBlockBounds(0.5F - f8, 0.5F, 0.0F, 0.5F + f8, 1.0F - f8, 1.0F);
					}
				...
				if(i2 == 1) {
					...
					tessellator.startDrawingQuads();
					tessellator.setNormal(0.0F, -1.0F, 0.0F);
					this.renderBottomFace(block, 0.0D, 0.0D, 0.0D, block.getBlockTextureFromSideAndMetadata(0, i2));
					tessellator.draw();
					tessellator.startDrawingQuads();
					tessellator.setNormal(0.0F, 1.0F, 0.0F);
					this.renderTopFace(block, 0.0D, 0.0D, 0.0D, block.getBlockTextureFromSideAndMetadata(1, i2));
					tessellator.draw();
					tessellator.startDrawingQuads();
					tessellator.setNormal(0.0F, 0.0F, -1.0F);
					this.renderEastFace(block, 0.0D, 0.0D, 0.0D, block.getBlockTextureFromSideAndMetadata(2, i2));
					tessellator.draw();
					tessellator.startDrawingQuads();
					tessellator.setNormal(0.0F, 0.0F, 1.0F);
					this.renderWestFace(block, 0.0D, 0.0D, 0.0D, block.getBlockTextureFromSideAndMetadata(3, i2));
					tessellator.draw();
					tessellator.startDrawingQuads();
					tessellator.setNormal(-1.0F, 0.0F, 0.0F);
					this.renderNorthFace(block, 0.0D, 0.0D, 0.0D, block.getBlockTextureFromSideAndMetadata(4, i2));
					tessellator.draw();
					tessellator.startDrawingQuads();
					tessellator.setNormal(1.0F, 0.0F, 0.0F);
					this.renderSouthFace(block, 0.0D, 0.0D, 0.0D, block.getBlockTextureFromSideAndMetadata(5, i2));
					tessellator.draw();
				} else {
