...
public abstract class WorldProvider {
	...
	public static WorldProvider getProviderForTerrainType(WorldType terrainType) {
		if(terrainType == WorldType.ALPHA || terrainType == WorldType.ALPHA_SNOW || terrainType == WorldType.INFDEV) return new WorldProviderSurfaceClassic();
	...
	protected double getSeaLevelForRendering() {
