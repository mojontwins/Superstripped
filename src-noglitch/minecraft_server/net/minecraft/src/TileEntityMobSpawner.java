			...
			if(!this.worldObj.isRemote) {
				...
				for(int i8 = 0; i8 < b7; ++i8) {
					...
					if(entityLiving9 != null) {
						...
						//if(this.worldObj.checkIfAABBIsClear(entityLiving9.boundingBox) && this.worldObj.getCollidingBoundingBoxes(entityLiving9, entityLiving9.boundingBox).size() == 0 && !this.worldObj.isAnyLiquid(entityLiving9.boundingBox)) {
