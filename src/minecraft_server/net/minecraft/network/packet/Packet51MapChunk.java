...
public class Packet51MapChunk extends Packet {
	...
	public Packet51MapChunk(Chunk chunk, boolean isNewChunk, int updateHash) {
		...
		// each subchunk use 6 nibbles (3 bytes) per block: 2 ID, 2 meta, 2 light, hence
		int byteLength = 2048 * (6 * blockLSBsubChunks + blockMSBsubChunks);
		if(isNewChunk) {
			byteLength += 256;
		}
	...
	public void readPacketData(DataInputStream dis) throws IOException {
		...
		// Was 12288 = 4096 (block lsb) + 4096 (light) + 4096 (meta/block msb)
		// Now we need 14336 = 4096 + 4096 + 4096 + 2048
		int size = 14336 * blockLSBsubChunks;
